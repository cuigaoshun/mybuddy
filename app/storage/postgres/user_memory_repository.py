...
class PostgresUserMemoryRepository(UserMemoryRepository):
    ...
    def __init__(self, engine: Engine) -> None:
        ...
        self._table = Table(
            ...
            Column("last_processed_record_id", BigInteger, nullable=True),
    ...
    def get_by_user(self, user_id: str) -> UserMemory | None:
        statement = (
            select(
                ...
                self._table.c.last_processed_record_id,
    ...
    def save(self, user_memory: UserMemory) -> None:
        statement = insert(self._table).values(
            ...
            last_processed_record_id=user_memory.last_processed_record_id,
